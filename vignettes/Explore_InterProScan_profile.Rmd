...
```{r, eval=FALSE}
interpro_pfam_profile<-read_interpro(data_interpro = "../inst/extdata/Interpro_test.tsv", database="Pfam", profile = F)
```

Let's change de column name "PFAM" to "Pfam" to agree with *´Rbims´*:
```{r, warning=FALSE, message=FALSE}
library(dplyr)
interpro_pfam_profile <- interpro_pfam_profile %>% rename(Pfam=PFAM)
```
