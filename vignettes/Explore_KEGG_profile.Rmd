...
[read_ko](https://mirnavazquez.github.io/RbiMs/reference/read_ko.html) can read as input file the files obtained from [KofamKOALA/KofamScan](https://www.genome.jp/tools/kofamkoala/) or [KAAS](https://www.genome.jp/kegg/kaas/). If you use both and there are different hits for a KO in both searches, it will take the hit from KofamKOALA/KofamScan.
