...
We are actively developing rbims, so for now it is not available at CRAN or Bioconductor, however you can access the development version from [GitHub](https://github.com/mirnavazquez/RbiMs).
...
- Valerie De Anda and Pedro Leão  - Curated the rbims database of metabolism. 
